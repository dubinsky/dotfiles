...
https://github.com/dubinsky/dotfiles/tree/master/.config/yadm/bootstrap.d/install-arch-packages.txt[packages];

- https://github.com/dubinsky/dotfiles/tree/master/.config/yadm/bootstrap.d/aur-packages.txt[AUR]
https://github.com/dubinsky/dotfiles/tree/master/.config/yadm/bootstrap.d/install-aur-packages.txt[packages];
