...
- manual: open the vault in `Podval/dub.podval.org`
- manual: change Omarchy theme (this makes Omarchy theme available in Obsidian)
- manual: set theme to `Omarchy` so that Obsidian follows theme changes
...
- Calibre Library: https://github.com/dubinsky/dotfiles/tree/master/.config/calibre/global.py.json[.config/calibre/global.py.json]

- Zotero profile: https://github.com/dubinsky/dotfiles/tree/master/.zotero/zotero/profiles.ini[.zotero/zotero/profiles.ini]

- Zotero preferences: https://github.com/dubinsky/dotfiles/tree/master/.zotero/zotero/kx3ct6er.default/prefs.js[.zotero/zotero/kx3ct6er.default/prefs.js]

- manual: install https://github.com/wileyyugioh/zotmoov[ZotMoove] Zotero plugin

- manual: install https://retorque.re/zotero-better-bibtex/[Better BibTex] Zotero plugin

- Zotero keyboard binding:
https://github.com/dubinsky/dotfiles/tree/master/.config/hypr/bindings.conf[.config/hypr/bindings.conf];

- Calibre keyboard binding:
https://github.com/dubinsky/dotfiles/tree/master/.config/hypr/bindings.conf[.config/hypr/bindings.conf];
