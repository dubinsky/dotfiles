...
- udev rules: https://github.com/dubinsky/dotfiles/tree/master/.config/yadm/bootstrap.d/50-zsa.rules[~/.config/yadm/bootstrap.d/50-zsa.rules]
...
- bootstrap: https://github.com/dubinsky/dotfiles/tree/master/.config/yadm/bootstrap.d/firmware.sh[~/.config/yadm/bootstrap.d/firmware.sh]
...
- bootstrap: https://github.com/dubinsky/dotfiles/tree/master/.config/yadm/bootstrap.d/yubikey.sh[~/.config/yadm/bootstrap.d/yubikey.sh]
